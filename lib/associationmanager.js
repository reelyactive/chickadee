 ...
 * @param {function} callback Function to call on completion.
 */
AssociationManager.prototype.retrieve = function(id, callback) {
  var self = this;

  self.db.find({ _id: id }, { _id: 0 }, function(err, devices) {
 ...
 * @param {function} callback Function to call on completion.
 */
AssociationManager.prototype.replace = function(id, url, tags, callback) {
  var self = this;
  var association = {};
