...
function Chickadee(options) {
  ...
  this.router.route('/id/:id')
    ...
    .get(function(req, res) {
      ...
      self.retrieveDevice(identifier, req, function(response, status) {
        res.status(status).json(response);
      });
    })
    ...
    .put(function(req, res) {
      var identifier = req.param('id');
      var url = req.body.url;
      self.replaceDevice(identifier, url, req, function(response, status) {
        res.status(status).json(response);
      });
    })
    ...
    .delete(function(req, res) {
      var identifier = req.param('id');
      self.deleteDevice(identifier, req, function(response, status) {
        res.status(status).json(response);
      });
    });
 ...
 * @param {callback} callback Function to call on completion.
 */
Chickadee.prototype.retrieveDevice = function(identifier, req, callback) {
  var self = this;
 ...
 * @param {callback} callback Function to call on completion.
 */
Chickadee.prototype.replaceDevice = function(identifier, url, req, callback) {
  var self = this;
  routeNotImplemented(callback);
}
 ...
 * @param {callback} callback Function to call on completion.
 */
Chickadee.prototype.deleteDevice = function(identifier, req, callback) {
  var self = this;
  routeNotImplemented(callback);
}
