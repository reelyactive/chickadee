...
function Chickadee(options) {
  ...
  this.router.route('/id')
    ...
    .get(function(req, res) {
      res.json(responseHandler.prepareResponse(responseHandler.NOTIMPLEMENTED));
    })

    .post(function(req, res) {
      self.createDevice(req.body.identifier, req.body.url, function(response, status) {
  ...
  this.router.route('/at')
    ...
    .post(function(req, res) {
      self.createPlace(req.body.place, req.body.ids, function(response, status) {
        res.status(status).json(response);
      });
    });
