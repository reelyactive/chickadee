 ...
 */
Chickadee.prototype.getDevicesContext = function(req, options, rootUrl, queryPath,
                                                 callback) {
  var self = this;
  var status;
  var response;
  ...
  if (self.dataStore) {
    convertOptionsParamsToIds(self, req, options, function(err) {
      if (!err) {
        self.dataStore.getState(options, function(state) {
          self.associations.addUrls(req, state, function(context) {
 ...
 * @param {callback} callback Function to call on completion.
 */
Chickadee.prototype.getAssociation = function(req, id, property, rootUrl, queryPath,
                                              callback) {
  var self = this;
  var status;
  var response;
