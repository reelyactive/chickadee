...
class Chickadee {
  ...
  constructor(options) {
    ...
    this.associations = new AssociationsManager(options, chimps,
                                                associationsDatabase);
    this.context = new ContextManager(options, barnacles, chimps,
                                      associationsDatabase);
    this.features = new FeaturesManager(options, chimps, featuresDatabase);
