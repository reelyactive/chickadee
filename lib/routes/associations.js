...
function replaceAssociation(req, res) {
  ...
  var rootUrl = req.protocol + '://' + req.get('host');
  var queryPath = req.originalUrl;
  req.chickadee.setAssociation(req, id, url, directory, tags, rootUrl, queryPath,
    function(response, status) {
      res.status(status).json(response);
    });
}
...
function replaceAssociationUrl(req, res) {
  ...
  var rootUrl = req.protocol + '://' + req.get('host');
  var queryPath = req.originalUrl;
  req.chickadee.setAssociation(req, id, url, null, null, rootUrl, queryPath,
    function(response, status) {
      res.status(status).json(response);
    });
}
...
function replaceAssociationDirectory(req, res) {
  ...
  var rootUrl = req.protocol + '://' + req.get('host');
  var queryPath = req.originalUrl;
  req.chickadee.setAssociation(req, id, null, directory, null, rootUrl, queryPath,
    function(response, status) {
      res.status(status).json(response);
    });
}
...
function replaceAssociationTags(req, res) {
  ...
  var rootUrl = req.protocol + '://' + req.get('host');
  var queryPath = req.originalUrl;
  req.chickadee.setAssociation(req, id, null, null, tags, rootUrl, queryPath,
    function(response, status) {
      res.status(status).json(response);
    });
}
