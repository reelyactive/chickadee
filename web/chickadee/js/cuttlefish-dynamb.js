...
let cuttlefishDynamb = (function() {
  ...
  const STANDARD_DATA_PROPERTIES = {
      ...
      isTamperDetected: { icon: "fas fa-exclamation-triangle",
                          transform: "booleanArray" },
      isTamperDetectedCycle: { icon: "fas fa-exclamation-triangle",
                               transform: "cycle" },
      ...
      numberOfReceivedDevices: { icon: "fas fa-broadcast-tower",
                                 suffix: " Rx (total)",
                                 transform: "toFixed(0)" },
      numberOfStrongestReceivedDevices: { icon: "fas fa-broadcast-tower",
                                          suffix: " Rx (strongest)",
                                          transform: "toFixed(0)" },
